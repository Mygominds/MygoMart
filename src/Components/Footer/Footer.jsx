        ...
        <Row>
          <Col lg='4' className='md-4'>
            <div className="logo">
              ...
              <div>
                <h1 className='text-white'>MyGo MaRt</h1>
              </div>
            </div>
            ...
            <div className="footer_quick-links me-auto">
              ...
              <ListGroup className='footer_contact'>
                <ListGroupItem className='ps-0 border-0 d-flex align-ite s-center gap-2'>
                  ...
                  <p>123, MygoMinds, KPHB--Kukatpally, Hyderabad</p>
                </ListGroupItem>
                <ListGroupItem className='ps-0 border-0 d-flex align-ite s-center gap-2'>
          ...
          <Col lg="12" className='md-4'>
            <p className='footer_Copyright'>Cpyrights{year} developed by Mygominds. All rights reserved.</p>
